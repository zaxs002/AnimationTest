...
public class ArcDuiHaoAnimationView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public ArcDuiHaoAnimationView(Context context) {
        this(context, null, 0);
    }

    public ArcDuiHaoAnimationView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcDuiHaoAnimationView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }, 400);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (currentView instanceof EditText && nextView instanceof EditText) {
            ...
            int width = 60;
            mRectF = new RectF(currentRect.right - (width / 2) - 20, currentRect.top + 10 - actionStatusBarHeight,
                    currentRect.right + width / 2, currentRect.bottom - 16 - actionStatusBarHeight);
